...
export default function ProjectCard({
  ...
  const CardInner = (
    <div className={`${className} flex h-full flex-col items-start justify-start overflow-hidden`}>
      {/* Image (optional) */}
      {imageSrc && (
        <div
      ...
      <div className="w-full">
        ...
        <p className="text-sm leading-relaxed opacity-90 tracking-normal">{description}</p>
      </div>
    </div>
  );
